...
defined('_JEXEC') or die;
	...
	class OsBrowser {
		...
		public function OsBrowser($useragent="") {
			$this->reset();
			if( $useragent != "" ) {
		...
		*/
		...
		public function returnisMobile(){
			return (
	    ...
	    /**
	     * Determine if the browser is Sony or not (last updated 1.7)
	     * @return boolean True if the browser is Nokia otherwise false
	     */
	    protected function checkBrowserSony() {
		    if( preg_match("/Sony([^\/]+)\/([^ SP]+)/i",$this->_agent,$matches) ) {
			    $this->setVersion($matches[2]);
				$this->setBrowser( self::BROWSER_SONY );
			    $this->setMobile(true);
			    return true;
		    }
			return false;
	    ...
	    /**
	     * Determine if the browser is Samsung or not (last updated 1.7)
	     * @return boolean True if the browser is Nokia otherwise false
	     */
	    protected function checkBrowserSamsung() {
		    if( preg_match("/Samsung([^\/]+)\/([^ SP]+)/i",$this->_agent,$matches) ) {
			    $this->setVersion($matches[2]);

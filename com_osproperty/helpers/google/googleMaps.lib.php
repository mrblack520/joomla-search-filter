...
if(!class_exists('Plugin_googleMaps_base')){
...
if(!class_exists('Plugin_googleMaps')){
	...
	-->\n\n";
			...
			$output .= "\n"."<script type=\"text/javascript\" src=\"http://maps.googleapis.com/maps/api/js?sensor=false&amp;language=".$this->lang.$key.'"></script>';
